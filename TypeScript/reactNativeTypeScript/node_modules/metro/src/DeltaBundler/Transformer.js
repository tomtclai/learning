...
require('metro-cache');const Cache = _require.Cache,stableHash = _require.stableHash;
...
class Transformer {
  ...
  {var _this = this;return _asyncToGenerator(function* () {
      const cache = _this._cache;const
      ...
      transformerOptions.customTransformOptions,dev = transformerOptions.dev,experimentalImportSupport = transformerOptions.experimentalImportSupport,hot = transformerOptions.hot,inlineRequires = transformerOptions.inlineRequires,minify = transformerOptions.minify,platform = transformerOptions.platform,type = transformerOptions.type,extra = _objectWithoutProperties(transformerOptions, ['customTransformOptions', 'dev', 'experimentalImportSupport', 'hot', 'inlineRequires', 'minify', 'platform', 'type']);
