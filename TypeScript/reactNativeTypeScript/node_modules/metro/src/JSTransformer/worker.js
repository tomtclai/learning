...
const normalizePseudoglobals = require('./worker/normalizePseudoglobals');var _require =
require('@babel/core');const transformFromAstSync = _require.transformFromAstSync;var _require2 =
require('metro-cache');const stableHash = _require2.stableHash;
const types = require('@babel/types');var _require3 =





require('metro-source-map');const fromRawMappings = _require3.fromRawMappings,toBabelSegments = _require3.toBabelSegments,toSegmentTuple = _require3.toSegmentTuple;
...
class JsTransformer {
  ...
  {var _this = this;return _asyncToGenerator(function* () {
      ...
      if (filename.endsWith('.json')) {
        ...
        if (options.minify) {var _ref =
          yield _this._minifyCode(filename, code, sourceCode, map);map = _ref.map;code = _ref.code;
        }
      ...
      const transformer = require(_this._config.
      ...
      if (type === 'js/script') {
        ...
        try {
          const opts = {
            ...
            inlineableCalls: [importDefault, importAll],
            keepRequireNames: options.dev };var _collectDependencies =
      ...
      if (options.minify) {var _ref2 =
        yield _this._minifyCode(
        filename,
        result.code,
        sourceCode,
        map,
        { reserved });map = _ref2.map;code = _ref2.code;
  ...
  {var _this2 = this;let options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};return _asyncToGenerator(function* () {
  ...
  getCacheKey() {var _config =
    this._config;const babelTransformerPath = _config.babelTransformerPath,minifierPath = _config.minifierPath,config = _objectWithoutProperties(_config, ['babelTransformerPath', 'minifierPath']);
