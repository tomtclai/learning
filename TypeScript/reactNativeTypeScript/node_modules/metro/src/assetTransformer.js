...
'use strict';let transform = (() => {var _ref = _asyncToGenerator(
  ...
  assetRegistryPath,
  assetDataPlugins)
  {let filename = _ref2.filename,options = _ref2.options,src = _ref2.src;
    options = options || {
      platform: '',
      projectRoot: '',
