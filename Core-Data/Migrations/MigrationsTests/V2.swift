...
private struct MoodV2: TestEntityData {
    ...
    init(markedForRemoteDeletion: Bool, country: CountryV2?, date: Date, latitude: Double, longitude: Double, markedForDeletionDate: Date?, creatorID: String?, remoteID: String?, colors: Data, rating: Int) {
...
private struct CountryV2: TestEntityData {
    ...
    let continent: ContinentV2?
    let markedForDeletionDate: Date?
    let updatedAt: Date
    var moods: [MoodV2] = []

    init(numberOfMoods: Int, numericISO3166Code: Int, continent: ContinentV2?, markedForDeletionDate: Date?, updatedAt: Date) {
...
let v2Data: TestVersionData = {
    ...
    var country21 = CountryV2(numberOfMoods: 2, numericISO3166Code: 710, continent: continent2, markedForDeletionDate: nil, updatedAt: Date(timeIntervalSinceReferenceDate: 464687061.782827))
    var country30 = CountryV2(numberOfMoods: 1, numericISO3166Code: 704, continent: continent1, markedForDeletionDate: nil, updatedAt: Date(timeIntervalSinceReferenceDate: 464687061.722586))
    var country31 = CountryV2(numberOfMoods: 1, numericISO3166Code: 231, continent: continent2, markedForDeletionDate: nil, updatedAt: Date(timeIntervalSinceReferenceDate: 464687061.668211))

    let mood1 = MoodV2(markedForRemoteDeletion: false, country: country30, date: Date(timeIntervalSinceReferenceDate: 464441952.529884), latitude: 13.154376, longitude: 108.193359, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "64C6E1D4-7C2E-4F04-B867-1A9E2941F9FF", colors: Data(base64Encoded: "a2Va3d/kSEIxJyQLiIeGCwkDOSwLmJmd", options: NSData.Base64DecodingOptions())!, rating: 0)
    let mood2 = MoodV2(markedForRemoteDeletion: false, country: country21, date: Date(timeIntervalSinceReferenceDate: 464369360.734390), latitude: -26.000000, longitude: 28.000000, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "47300BAD-DE7D-4B54-B94C-04A3EE4CD0C5", colors: Data(base64Encoded: "a2Va3d/kSEIxJyQLiIeGCwkDOSwLmJmd", options: NSData.Base64DecodingOptions())!, rating: 0)
    let mood3 = MoodV2(markedForRemoteDeletion: false, country: country31, date: Date(timeIntervalSinceReferenceDate: 464442000.641578), latitude: 7.013668, longitude: 41.308594, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "83922344-ED0B-4ABE-B8B0-E00F4E7E1D94", colors: Data(base64Encoded: "8fP4YVtDZWU3usfgRT8gTE8cTTktfHlf", options: NSData.Base64DecodingOptions())!, rating: 0)
    let mood4 = MoodV2(markedForRemoteDeletion: false, country: country21, date: Date(timeIntervalSinceReferenceDate: 464369352.554507), latitude: -26.000000, longitude: 28.000000, markedForDeletionDate: nil, creatorID: "__defaultOwner__", remoteID: "3A9BAEFD-7716-41C0-9FFF-A7C4BCE32679", colors: Data(base64Encoded: "XkUa493ZlI1/epW2MSIOFQ8HQSoOTUAs", options: NSData.Base64DecodingOptions())!, rating: 0)
