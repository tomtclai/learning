...
class RecognizerViewController: UIViewController {
    ...
    private func recognize(image: UIImage) -> String? {
        guard let pixelBufferImage = ImageToPixelBufferConverter.convertToPixelBuffer(image: image) else { return nil }
        guard let prediction = try? mobileNet.prediction(image: pixelBufferImage) else { return nil }
