...
enum ServerResponse {
    ...
    case Error(String)
    case Maintenance(String, String)
}

let success = ServerResponse.Result("6:00 am", "8:09 pm")
let failure = ServerResponse.Error("Out of cheese.")
let maintenance = ServerResponse.Maintenance("3:00 am", "4:00 am")
...
switch maintenance {
    ...
    case let .Maintenance(start, end):
        let serverResponse = "Maintenance scheduled for \(start) - \(end)."
}
